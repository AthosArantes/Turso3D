...
namespace Turso3D
{
	...
	float Ray::HitDistance(const void* vertexData, size_t vertexSize, const void* indexData, size_t indexSize, size_t indexStart, size_t indexCount, Vector3* outNormal) const
	{
		float nearest = M_INFINITY;
