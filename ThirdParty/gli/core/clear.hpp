...
namespace detail
{
	template <typename textureType, typename T, glm::qualifier P>
	struct clear
	{
		static void call(textureType & Texture, typename convert<textureType, T, P>::writeFunc Write, glm::vec<4, T, P> const& Color)
		{
			GLI_ASSERT(Write);
